                    ...
                    MDBoxLayout:
                        ...
                        MDBoxLayout:
                            ...
                            MDRoundFlatIconButton:
                                id: grade_button_course  # Added ID
                                text: "All Grades"
                                icon: "chevron-down"
                                ...
                                on_release: app.grade_menu_course.open()  # Opens the menu

                            # Filters (Dropdown Placeholders)
                            MDRoundFlatIconButton:
                                id: dept_button_course  # Added ID
                                ...
                                theme_text_color: "Custom"
                                text_color: 0.3, 0.3, 0.4, 1
                                on_release: app.menu_course.open()  # Opens the menu
                        ...
                        MDCard:
                            ...
                            MDBoxLayout:
                                ...
                                MDIconButton:
                                    icon: "chevron-left"
                                    on_release: app.prev_page_Course()
                                ...
                                MDIconButton:
                                    icon: "chevron-right"
                                    on_release: app.next_page_Course()
